    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,AuthenticationManager authenticationManager) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(authz -> authz
                    .requestMatchers("/h2-console/**", "/api/auth/register","/api/admin/invite/**","/api/auth/google/**","/api/admin/analytics/**").permitAll() // Allow access to H2 console and authentication endpoints without authentication
