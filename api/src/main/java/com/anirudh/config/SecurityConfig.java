    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,AuthenticationManager authenticationManager) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(authz -> authz
                    .requestMatchers("/h2-console/**", "/api/auth/register","/api/invite","google/login").permitAll() // Allow access to H2 console and authentication endpoints without authentication
